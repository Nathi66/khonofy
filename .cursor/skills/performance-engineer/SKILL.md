...
description: Improves query/UI performance within AEOS performance principles. Use for slow dashboards, reports, N+1 risks, or heavy list endpoints.
---
...
1. Read and obey `.kiro/skills/performance-engineer/SKILL.md` in full.
