...
description: Implements React/Vite UI per AEOS frontend specs and design system. Use when changing pages, components, dashboards, timesheets UI, calendar, or Tailwind/shadcn UI.
---
...
1. Read and obey `.kiro/skills/frontend-engineer/SKILL.md` in full.
...
6. If `AEOS_VERBOSE=true`, add a Current Agent / Reasoning / Outputs / Next Agent block per `.kiro/project/verbose-mode.md` when you act.
