...
description: Implements Express API, JWT auth, and role scoping per AEOS API specs. Use when changing backend/src, endpoints, serializers, or server-side permissions.
---
...
1. Read and obey `.kiro/skills/backend-engineer/SKILL.md` in full.
